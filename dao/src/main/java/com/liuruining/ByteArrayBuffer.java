...
public class ByteArrayBuffer extends OutputStream {
     ...
     * into this buffer.
     *
     * @throws java.io.IOException if the read operation fails with an {@link java.io.IOException}.
     */
    ...
    /**
     * Gets the underlying buffer that this {@link com.sun.xml.internal.ws.util.ByteArrayBuffer} uses.
    ...
    /**
     * Creates a new {@link java.io.InputStream} that reads from this buffer.
     */
    ...
    /**
     * Creates a new {@link java.io.InputStream} that reads a part of this buffer.
     */
