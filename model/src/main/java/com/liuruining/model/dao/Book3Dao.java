 ...
 * DAO for table book3.
*/
public class Book3Dao extends AbstractDao<Book3, Long> {

    public static final String TABLENAME = "book3";

    /**
     * Properties of entity Book3.<br/>
    ...
    */
    ...
    public Book3Dao(DaoConfig config) {
        super(config);
    }
    
    public Book3Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'book3' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'book3'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Book3 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Book3 readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Book3 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Book3 entity, long rowId) {
        entity.setID(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Book3 entity) {
        if(entity != null) {
            return entity.getID();
        } else {
            return null;
