...
public class Book2 implements java.io.Serializable {
    ...
    public Book2(Long ID) {
        this.ID = ID;
    }

    public Book2(Long ID, Boolean isSelect, String spelling, String meanning, String phonetic_alphabet, Long list) {
        this.ID = ID;
