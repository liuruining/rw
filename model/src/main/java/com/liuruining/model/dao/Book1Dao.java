 ...
 * DAO for table book1.
*/
public class Book1Dao extends AbstractDao<Book1, Long> {

    public static final String TABLENAME = "book1";

    /**
     * Properties of entity Book1.<br/>
    ...
    */
    ...
    public Book1Dao(DaoConfig config) {
        super(config);
    }
    
    public Book1Dao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'book1' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'book1'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Book1 entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public Book1 readEntity(Cursor cursor, int offset) {
        Book1 entity = new Book1( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Book1 entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Book1 entity, long rowId) {
        entity.setID(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Book1 entity) {
        if(entity != null) {
            return entity.getID();
        } else {
            return null;
