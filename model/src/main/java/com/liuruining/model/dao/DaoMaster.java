...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        Book1Dao.createTable(db, ifNotExists);
        Book2Dao.createTable(db, ifNotExists);
        Book3Dao.createTable(db, ifNotExists);
        WordDao.createTable(db, ifNotExists);
        WordLocationDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        BookDao.dropTable(db, ifExists);
        Book1Dao.dropTable(db, ifExists);
        Book2Dao.dropTable(db, ifExists);
        Book3Dao.dropTable(db, ifExists);
        WordDao.dropTable(db, ifExists);
        WordLocationDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(Book1Dao.class);
        registerDaoClass(Book2Dao.class);
        registerDaoClass(Book3Dao.class);
        registerDaoClass(WordDao.class);
        registerDaoClass(WordLocationDao.class);
    }
